...
| | |
|---|---|
| Version | 1.11.3 (src-layout, Python ≥ 3.10) |
| Command groups | 24 subcommand groups + 8 root commands |
| Test suite | 195 tests, ruff + mypy clean |
...
```
python -m pytest tests -q   # 195 tests, hermetic (MockTransport, one-shot routes)
